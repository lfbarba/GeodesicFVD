...
\newcommand{\patch}[2][P]{\ensuremath{\textsc{patch}_{\scriptscriptstyle #1}(#2)}}
...
\begin{proof}
\luis{To Do.}
%We know that this point exists because otherwise this process would visit a point $y$ inside of $\bcell{b, \s}$ for some site $b\in B$. 
%However, Lemma~\ref{lemma:Patch contains vcell} implies that $y\in \bcell{b, \s}$ is contained in the \icell of $b$ leading to a contradiction.
